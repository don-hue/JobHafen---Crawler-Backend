...
Ein **Multithreaded** Crawler, der Urls abarbeitet. Aktuell sind 10 ThreadPools aktiv. Der Crawler published ein Ergebnis in eine Queue, die dann vom 
Konsumenten (PostgresSQL Service) bearbeitet wird. 

Die Crawler werden *dynamisch* mittels einer **Factory** gebaut. 
